...
6. **MicroSD Card Module** - Data logging
...
VCC          →   3.3V
GND          →   GND
SCL          →   GPIO 22 (shared with BMP280)
SDA          →   GPIO 21 (shared with BMP280)
```
...
### Step 2: Connect I2C Sensors (BMP280 & AHT20)

1. Connect both sensors to the same I2C bus
2. BMP280 address: 0x76 or 0x77
3. AHT20 address: 0x38
